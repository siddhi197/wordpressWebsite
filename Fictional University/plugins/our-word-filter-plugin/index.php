       ...
       <div class="wrap">
        ...
        <form  method="POST">
            ...
            <div class="word-filter__flex-container">
                <textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, awful, horrible, mean" ><?php echo esc_textarea(get_option('plugin_words_to_filter'));?></textarea>
            </div>
